# Batch_089 Music Fact Verification Script
...
$suspiciousDir = "D:\数据收集\luotianyi-db\processed\rag\suspicious_music\Batch_089"
$today = "2026-06-08"

$files = @(
    "yueding-luotianyi-ver-qiangxianban.md",
    "yueding-luotianyi-ver-wanzhengban.md",
    "yueeryao.md",
    "yuegen.md",
    "yueguang.md",
    "yuehuamange.md",
    "yuehuixuanyan-featluotianyi.md",
    "yueliangchuan.md",
    "yueliangdaibiaowodexin.md",
    "yueliangdejiageshijiubangshiwubianshi.md",
    "yueqiupianxinlv.md",
    "yuequanfangwen.md",
    "yueshen.md",
    "yueshiguxiangming-lezhenglingluotianyi.md",
    "yueshimeng.md",
    "yuexiachan.md",
    "yuexiaxian.md",
    "yueyawan.md",
    ...
    "yufutongyou.md",
    "yuge.md",
    "yuguangshuiyin-luotianyi.md",
    "yugui.md",
    "yuguoqudenidaobie.md",
    "yuhaodawomeiyousan.md",
    "yuhouhong.md",
    "yuhui.md",
    "yuhuibucover-lezhengling-luotianyi.md",
    "yuhujie.md",
    "yuhujie-2.md",
    "yujiang-ver-featqingmuaoki.md",
    "yujianhongchen.md",
    "yujiaxue.md",
    "yujizhuang.md",
    "yujuhaiying.md",
    "yujunyuan.md",
    "yulankaihuasanyuesan.md",
    "yuleihai.md",
    "yulikanhua.md",
    "yumengjiluotianyiver.md",
    "yumenxing.md",
    "yumuhuashuyuni.md",
    "yunbiyao.md",
    "yuncaidizaozhe.md",
...
# Ensure suspicious directory exists
if (-not (Test-Path $suspiciousDir)) {
    New-Item -ItemType Directory -Path $suspiciousDir -Force | Out-Null
}
...
$reportPath = Join-Path $reportDir "Batch_089_verification.json"
...
# Print summary
Write-Host "`n=========================================="
Write-Host "  Batch_089 Verification Complete"
Write-Host "=========================================="
