# Batch_090 Music Fact Verification Script
...
$suspiciousDir = "D:\数据收集\luotianyi-db\processed\rag\suspicious_music\Batch_090"
$today = "2026-06-08"
...
$files = @(
    ...
    "yunge-5.md",
    "yunge-6.md",
    "yunhai-feat-luotianyi.md",
    "yunhehuoche.md",
    "yunigongdudexiatian.md",
    "yunitonghang.md",
    "yunquanbuxiangzhangdasuohun.md",
    "yunquanchuanshuodemonvsuohun.md",
    "yunquanfengyihugsuohun.md",
    "yunquanfengyimofashisuohun.md",
    "yunquanhuaxianzisuohun.md",
    "yunquankill-my-painsuohun.md",
    "yunquanmaishisanfanmoshilusuohun.md",
    "yunquanwojinjisuohun.md",
    "yunquanzizuozishousuohun.md",
    "yunruluanrang.md",
    "yunshangchengbao.md",
    "yunshanjinchu.md",
    "yunweishenpan.md",
    "yunxikeluotianyi.md",
    "yunxing.md",
    "yunxingcover-luotianyi.md",
    "yunyuezhihai.md",
    "yunyupugongying.md",
    "yunzhishang.md",
    "yunzhongfan.md",
    "yunzhuanyanyuzhuange-featluotianyi.md",
    "yuqishu.md",
    "yuqunxinggaobie.md",
    "yurendelangmanzhuyi.md",
    "yusan.md",
    "yushijiejiaoshouhou-luotianyiai.md",
    "yushiwojuqileqiang.md",
    "yushuichunsheng.md",
    "yusongsheng.md",
    "yutian.md",
    "yuweiting.md",
    "yuweixunyutian.md",
    "yuwoduhuo.md",
    "yuwoyushengluotianyi-lezhengling.md",
    "yuxin.md",
    "yuxingzhiyue.md",
    "yuxuanji.md",
    "yuyan.md",
...
function Test-ViewCountSimilar {
    ...
    if ($parsedView -eq 0) { return $null }
...
foreach ($file in $files) {
    ...
    if ([string]::IsNullOrEmpty($bvid)) {
        ...
        $results += $result
        Write-Host "  -> unverifiable (no BVID)"
        continue
    }
    ...
    if ($null -eq $apiData) {
        ...
        $results += $result
        Write-Host "  -> unverifiable (API error)"
        continue
    }
    ...
    $results += $result
    Write-Host "  -> $($result.classification) (matches=$matchCount/$checks)"
...
# Generate report - recalculate summary
...
$reportPath = Join-Path $reportDir "Batch_090_verification.json"
...
# Print summary
Write-Host "`n=========================================="
Write-Host "  Batch_090 Verification Complete"
Write-Host "=========================================="
...
Write-Host "  API Calls:     $apiCallsMade"
